...
Assignment 2 – Malware Analysis with Docker:

- Used Docker to safely run a simulated malware file in an isolated container.
...
2) Run the malware in an isolated container and capture behavior
